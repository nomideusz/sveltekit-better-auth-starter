...
| Email | [`@nomideusz/svelte-notify`](https://www.npmjs.com/package/@nomideusz/svelte-notify) — branded templates + SMTP transport (logs instead of sending when SMTP is unset) |
